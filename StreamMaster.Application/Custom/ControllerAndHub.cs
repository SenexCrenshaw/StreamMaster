...
namespace StreamMaster.Application.Custom.Controllers
{
    ...
    public partial class CustomController(ILogger<CustomController> _logger) : ApiControllerBase, ICustomController
    {
        ...
        public async Task<ActionResult<List<CustomPlayList>>> GetCustomPlayLists()
        {
            try
            {
            var ret = await APIStatsLogger.DebugAPI(Sender.Send(new GetCustomPlayListsRequest())).ConfigureAwait(false);
        ...
        public async Task<ActionResult<List<CustomPlayList>>> GetIntroPlayLists()
        {
            try
            {
            var ret = await APIStatsLogger.DebugAPI(Sender.Send(new GetIntroPlayListsRequest())).ConfigureAwait(false);
        ...
        {
            var ret = await APIStatsLogger.DebugAPI(Sender.Send(new ScanForCustomRequest())).ConfigureAwait(false);
