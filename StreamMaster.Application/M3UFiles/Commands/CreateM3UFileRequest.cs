...
public record CreateM3UFileRequest(string Name, int MaxStreamCount, string? UrlSource, bool? SyncChannels, int? HoursToUpdate, List<string>? VODTags) : IRequest<APIResponse>;
