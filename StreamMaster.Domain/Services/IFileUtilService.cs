...
namespace StreamMaster.Domain.Services
{
    ...
    {
        Task<List<XmltvChannel>> GetChannelsFromXmlAsync(string epgPath, CancellationToken cancellationToken = default);

        Task<List<XmltvChannel>> GetChannelsFromXmlAsync(EPGFile epgFile, CancellationToken cancellationToken = default);
