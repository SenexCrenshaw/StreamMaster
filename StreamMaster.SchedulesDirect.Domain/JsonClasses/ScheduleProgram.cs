...
public class ScheduleProgram
{
    ...
    public DateTime AirDateTime { get; set; } = DateTime.MinValue;
    ...
    public string LiveTapeDelay { get; set; } = string.Empty;
    ...
    public string IsPremiereOrFinale { get; set; } = string.Empty;
    ...
    public ScheduleMultipart Multipart { get; set; } = new();
}
