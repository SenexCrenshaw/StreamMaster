...
public interface ISchedulesDirect
{
    ...
    Task<string> GetEpg(List<StationIdLineUp> stationIdLineUps, CancellationToken cancellationToken);
    ...
    Task<LineUpsResult?> GetLineups(CancellationToken cancellationToken);
