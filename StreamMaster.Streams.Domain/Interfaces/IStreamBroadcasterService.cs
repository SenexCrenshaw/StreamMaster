...
namespace StreamMaster.Streams.Domain.Interfaces
{
    ...
    /// </summary>
    public interface IStreamBroadcasterService
    {
        /// <summary>
        ...
        IStreamBroadcaster? GetStreamBroadcaster(string? key);
        ...
        Task<IStreamBroadcaster?> GetOrCreateStreamBroadcasterAsync(string channelName, SMStreamInfo smStreamInfo, CancellationToken cancellationToken);
        ...
        List<IStreamBroadcaster> GetStreamBroadcasters();
    }
}
