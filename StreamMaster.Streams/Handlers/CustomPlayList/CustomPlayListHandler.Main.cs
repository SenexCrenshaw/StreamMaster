...
public sealed partial class CustomPlayListHandler : IStreamHandler
{
    ...
    public CustomPlayListHandler(IChannelStatus channelStatus, IOptionsMonitor<Setting> intSettings, ILoggerFactory loggerFactory, IStreamStreamingStatisticsManager streamStreamingStatisticsManager)
    {
