...
//            videoInfo.StreamName = SMStreamInfo.SourceName;
//            LastVideoInfoRun = SMDT.UtcNow;
//            _videoInfo = videoInfo;
//            logger.LogInformation("Retrieved video information for {VideoStreamName}.", SMStreamInfo.SourceName);
//        }
...
//            await using Timer timer = new(delegate { process.Kill(); }, null, 5000, Timeout.Infinite);
