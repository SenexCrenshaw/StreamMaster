...
internal class GetChannelGroupFromVideoStreamIdHandler : BaseMediatorRequestHandler, IRequestHandler<GetChannelGroupFromVideoStreamId, ChannelGroupDto?>
{
    ...
    public GetChannelGroupFromVideoStreamIdHandler(ILogger<GetChannelGroupFromVideoStreamId> logger, IRepositoryWrapper repository, IMapper mapper,ISettingsService settingsService, IPublisher publisher, ISender sender, IHubContext<StreamMasterHub, IStreamMasterHub> hubContext)
