...
internal class GetChannelGroupsFromVideoStreamIdsHandler : BaseMediatorRequestHandler, IRequestHandler<GetChannelGroupsFromVideoStreamIds, List<ChannelGroupDto>>
{
    ...
    public GetChannelGroupsFromVideoStreamIdsHandler(ILogger<GetChannelGroupsFromVideoStreamIds> logger, IRepositoryWrapper repository, IMapper mapper,ISettingsService settingsService, IPublisher publisher, ISender sender, IHubContext<StreamMasterHub, IStreamMasterHub> hubContext)
