...
namespace StreamMasterInfrastructure.Common.Mappings;

public class StreamMasterInfrastructureMappingProfile : Profile
{
    public StreamMasterInfrastructureMappingProfile()
    {
