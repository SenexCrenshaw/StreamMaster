...
{
    public StreamStreamInfo(string streamUrl, CircularRingBuffer buffer, Task streamingTask, int m3uFileId, int maxStreams,CancellationTokenSource cancellationTokenSource)
    {
        StreamUrl = streamUrl;
