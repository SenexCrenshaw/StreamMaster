...
namespace StreamMasterInfrastructure.Persistence.Migrations
{
    ...
    [Migration("20230719154616_DBCleanup2")]
    partial class DBCleanup2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StreamMasterDomain.Entities.VideoStreamChildVideoStream", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("ParentRelationshipsId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ParentRelationshipsId");

                    b.ToTable("VideoStreamChildVideoStream");
                });
            ...
            modelBuilder.Entity("StreamMasterDomain.Entities.VideoStreamChildVideoStream", b =>
                {
                    b.HasOne("StreamMasterDomain.Entities.VideoStream", null)
                        .WithMany()
                        .HasForeignKey("ParentRelationshipsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
