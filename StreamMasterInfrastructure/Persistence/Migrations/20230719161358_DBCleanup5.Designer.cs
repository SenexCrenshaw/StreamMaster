...
namespace StreamMasterInfrastructure.Persistence.Migrations
{
    ...
    [Migration("20230719161358_DBCleanup5")]
    partial class DBCleanup5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StreamMasterDomain.Entities.VideoStreamsChildVideoStream", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("ParentVideoStreamsId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ParentVideoStreamsId");

                    b.ToTable("VideoStreamsChildVideoStreams");
                });

            modelBuilder.Entity("StreamMasterDomain.Entities.StreamGroupChannelGroup", b =>
                {
                    b.HasOne("StreamMasterDomain.Entities.ChannelGroup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StreamMasterDomain.Entities.VideoStreamsChildVideoStream", b =>
                {
                    b.HasOne("StreamMasterDomain.Entities.VideoStream", null)
                        .WithMany()
                        .HasForeignKey("ParentVideoStreamsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
