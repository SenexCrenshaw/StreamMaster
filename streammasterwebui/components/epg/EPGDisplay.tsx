      ...
      {props.hidden !== true && (
        <>
          ...
          <Epg isLoading={isLoading} {...getEpgProps()}>
            <Layout
              {...getLayoutProps()}
              renderChannel={({ channel }) => <ChannelItem channel={channel} key={channel.uuid} />}
              renderProgram={({ program, ...rest }) => <ProgramComponent key={program.data.id} program={program} {...rest} onClick={onVideoStreamClick} />}
