...
export interface M3UFileEditDialogProperties {
...
const M3UFileEditDialog = ({ onM3UChanged, selectedFile, noButtons }: M3UFileEditDialogProperties) => {
  const defaultValues = {
    Name: '',
    MaxStreamCount: 1,
    HoursToUpdate: 72,
  ...
  return (
    <>
      ...
      {noButtons !== true && (
        <div className="flex col-12 gap-2 justify-content-end align-content-center">
          <ResetButton
...
export default React.memo(M3UFileEditDialog);
