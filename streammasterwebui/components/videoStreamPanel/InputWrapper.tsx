...
const InputWrapper: React.FC<InputWrapperProperties> = ({ columnSize, label, renderInput }) => (
  <div className={`flex flex-wrap col-${columnSize} justify-content-start align-items-center p-0 m-0`}>
    ...
    <div className="flex col-12 justify-content-start align-items-center p-0 m-0">{renderInput()}</div>
  </div>
);
