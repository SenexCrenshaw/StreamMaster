...
const StreamGroupChannelGroupsSelector = ({
  className,
  streamGroupId,
}: StreamGroupChannelGroupsInputs) => {
  ...
  const [syncStreamGroupChannelGroupsMutation, { isLoading }] =
    useStreamGroupChannelGroupSyncStreamGroupChannelGroupsMutation()
    ...
    <div className={`"flex w-full ${className}"`}>
      <MultiSelect
        ...
        onChange={async (e: MultiSelectChangeEvent) => {
          const toSend =
            {} as StreamGroupChannelGroupSyncStreamGroupChannelGroupsApiArg
