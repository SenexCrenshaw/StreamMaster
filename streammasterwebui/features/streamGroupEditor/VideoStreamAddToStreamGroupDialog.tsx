...
const VideoStreamAddToStreamGroupDialog = ({
  id,
  value,
}: VideoStreamAddToStreamGroupDialogProps) => {
  const [streamGroupVideoStreamsAddVideoStreamToStreamGroupMutation] =
    useStreamGroupVideoStreamsSyncVideoStreamToStreamGroupPostMutation()
...
VideoStreamAddToStreamGroupDialog.displayName =
  'VideoStreamAddToStreamGroupDialog'
