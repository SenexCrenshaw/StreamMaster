...
const injectedRtkApi = api
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      videoStreamsGetVideoStreamStreamGet: build.query<
        VideoStreamsGetVideoStreamStreamGetApiResponse,
        VideoStreamsGetVideoStreamStreamGetApiArg
      >({
        query: (queryArg) => ({ url: `/api/videostreams/stream/${queryArg}` }),
        providesTags: ['VideoStreams'],
      }),
      videoStreamsGetVideoStreamStreamHead: build.mutation<
        VideoStreamsGetVideoStreamStreamHeadApiResponse,
        VideoStreamsGetVideoStreamStreamHeadApiArg
      >({
        query: (queryArg) => ({
          url: `/api/videostreams/stream/${queryArg}`,
          method: 'HEAD',
        }),
        invalidatesTags: ['VideoStreams'],
      }),
      videoStreamsGetVideoStreamStreamGet2: build.query<
        VideoStreamsGetVideoStreamStreamGet2ApiResponse,
        VideoStreamsGetVideoStreamStreamGet2ApiArg
      >({
        query: (queryArg) => ({
      ...
      videoStreamsGetVideoStreamStreamHead2: build.mutation<
        VideoStreamsGetVideoStreamStreamHead2ApiResponse,
        VideoStreamsGetVideoStreamStreamHead2ApiArg
      >({
        query: (queryArg) => ({
          url: `/api/videostreams/stream/${queryArg}.mp4`,
          method: 'HEAD',
      ...
      videoStreamsGetVideoStreamStreamGet3: build.query<
        VideoStreamsGetVideoStreamStreamGet3ApiResponse,
        VideoStreamsGetVideoStreamStreamGet3ApiArg
      >({
        query: (queryArg) => ({
      ...
      videoStreamsGetVideoStreamStreamHead3: build.mutation<
        VideoStreamsGetVideoStreamStreamHead3ApiResponse,
        VideoStreamsGetVideoStreamStreamHead3ApiArg
      >({
        query: (queryArg) => ({
          url: `/api/videostreams/stream/${queryArg.encodedIds}/${queryArg.name}`,
          method: 'HEAD',
