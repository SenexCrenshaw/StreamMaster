...
const help_en: help_enType = {
  ...
  user: "User",
  videoStreamAlwaysUseEPGLogo: "Always use EPG Logo for Video Stream. If the EPG is changed to one containing a logo then the video stream logo will be set to that",
};
