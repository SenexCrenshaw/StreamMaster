...
const rootReducer = combineReducers({
  ...
  [enhancedApiStreamGroupChannelGroup.reducerPath]:
    enhancedApiStreamGroupChannelGroup.reducer,
  [enhancedApiStreamGroupVideoStreams.reducerPath]:
    enhancedApiStreamGroupVideoStreams.reducer,
  [enhancedApiStreamGroups.reducerPath]: enhancedApiStreamGroups.reducer,
  [enhancedApiVideoStreamLinks.reducerPath]:
    enhancedApiVideoStreamLinks.reducer,
  [enhancedApiVideoStreams.reducerPath]: enhancedApiVideoStreams.reducer,
  [enhancedApiVideoStreamLinksLocal.reducerPath]:
    enhancedApiVideoStreamLinksLocal.reducer,
  [enhancedApiVideoStreamsGetAllStatisticsLocal.reducerPath]:
    enhancedApiVideoStreamsGetAllStatisticsLocal.reducer,
  ...
  selectedChannelGroups: persistReducer(
    selectedItemsGroupsConfig,
    selectedChannelGroupsSliceReducer,
  ),
  selectedItems: selectedItemsSliceReducer,
  selectedStreamGroup: persistReducer(
    selectedStreamGroupConfig,
    selectedStreamGroupSliceReducer,
  ),
  selectedVideoStreams: persistReducer(
    selectedVideoStreamsConfig,
    selectedVideoStreamsSliceReducer,
  ),
