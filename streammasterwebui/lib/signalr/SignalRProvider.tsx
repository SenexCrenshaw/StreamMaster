...
export const SignalRProvider: React.FC<SignalRProviderProps> = ({ children }) => {
  ...
  const dataRefresh = useCallback(
    ...
    [
      ...
      getChannelGroups,
      getChannelGroupsFromSMChannels,
      getChannelMetrics,
      getCommandProfiles,
      getCustomPlayList,
      getCustomPlayLists,
      getDownloadServiceStatus,
      getEPGColors,
      getEPGFileNames,
      getEPGFilePreviewById,
      getEPGFiles,
      getEPGNextEPGNumber,
      getHeadendsByCountryPostal,
      getHeadendsToView,
      getIntroPlayLists,
      getIsSystemReady,
      getLineupPreviewChannel,
      getLogContents,
      getLogNames,
      getLogos,
      getM3UFileNames,
      ...
      getSettings,
      getSMChannelChannels,
      getSMChannelNameLogos,
      getSMChannelNames,
      getSMChannelStreams,
      getSMTasks,
      ...
      getStationPreviews,
      getStreamGroup,
      getStreamGroupProfiles,
      getStreamGroups,
      getStreamGroupSMChannels,
      getSubScribedHeadends,
