...
import { authLogOut } from './SignalRAuthLogOut';
...
import useGetIsSystemReady from '@lib/smAPI/Statistics/useGetIsSystemReady';
...
import useGetLogo from '@lib/smAPI/Logos/useGetLogo';
import useGetLogoForChannel from '@lib/smAPI/Logos/useGetLogoForChannel';
...
import useGetSMChannelUniqueName from '@lib/smAPI/SMChannels/useGetSMChannelUniqueName';
...
import useGetStreamConnectionMetricData from '@lib/smAPI/Statistics/useGetStreamConnectionMetricData';
import useGetStreamConnectionMetricDatas from '@lib/smAPI/Statistics/useGetStreamConnectionMetricDatas';
...
import useGetSystemStatus from '@lib/smAPI/Statistics/useGetSystemStatus';
...
export const SignalRProvider: React.FC<SignalRProviderProps> = ({ children }) => {
  ...
  const getCustomLogos = useGetCustomLogos();
  ...
  const getEPGFileNames = useGetEPGFileNames();
  ...
  const getLogContents = useGetLogContents();
  const getLogNames = useGetLogNames();
  const getLogo = useGetLogo();
  const getLogoForChannel = useGetLogoForChannel();
  ...
  const getSMChannelUniqueName = useGetSMChannelUniqueName();
  ...
  const getStreamConnectionMetricData = useGetStreamConnectionMetricData();
  const getStreamConnectionMetricDatas = useGetStreamConnectionMetricDatas();
  ...
  const dataRefresh = useCallback(
    (entity: string): void => {
      ...
      if (entity === 'GetCustomLogos') {
        getCustomLogos.SetIsForced(true);
        return;
      }
      ...
      if (entity === 'GetEPGFileNames') {
        getEPGFileNames.SetIsForced(true);
        return;
      }
      ...
      if (entity === 'GetLogContents') {
        getLogContents.SetIsForced(true);
        return;
      }
      if (entity === 'GetLogNames') {
        getLogNames.SetIsForced(true);
        return;
      }
      if (entity === 'GetLogo') {
        getLogo.SetIsForced(true);
        return;
      }
      if (entity === 'GetLogoForChannel') {
        getLogoForChannel.SetIsForced(true);
        return;
      }
      if (entity === 'GetLogos') {
      ...
      if (entity === 'GetSMChannelUniqueName') {
        getSMChannelUniqueName.SetIsForced(true);
        return;
      }
      ...
      if (entity === 'GetStreamConnectionMetricData') {
        getStreamConnectionMetricData.SetIsForced(true);
        return;
      }
      if (entity === 'GetStreamConnectionMetricDatas') {
        getStreamConnectionMetricDatas.SetIsForced(true);
        return;
      }
    ...
    [getAvailableCountries,getChannelGroups,getChannelGroupsFromSMChannels,getChannelMetrics,getCommandProfiles,getCustomLogos,getCustomPlayList,getCustomPlayLists,getDownloadServiceStatus,getEPGColors,getEPGFileNames,getEPGFilePreviewById,getEPGFiles,getEPGNextEPGNumber,getHeadendsByCountryPostal,getHeadendsToView,getIntroPlayLists,getIsSystemReady,getLineupPreviewChannel,getLogContents,getLogNames,getLogo,getLogoForChannel,getLogos,getM3UFileNames,getM3UFiles,getOutputProfile,getOutputProfiles,getPagedChannelGroups,getPagedEPGFiles,getPagedM3UFiles,getPagedSMChannels,getPagedSMStreams,getPagedStreamGroups,getSelectedStationIds,getSettings,getSMChannelChannels,getSMChannelStreams,getSMChannelUniqueName,getSMTasks,getStationChannelNames,getStationPreviews,getStreamConnectionMetricData,getStreamConnectionMetricDatas,getStreamGroup,getStreamGroupProfiles,getStreamGroups,getStreamGroupSMChannels,getSubScribedHeadends,getSubscribedLineups,getSystemStatus,getTaskIsRunning,getVideoInfo,getVideoInfos,getVs]
  );
  ...
  const setField = useCallback(
    (fieldDatas: FieldData[]): void => {
      fieldDatas.forEach((fieldData) => {
        ...
        if (fieldData.Entity === 'GetCustomLogos') {
          getCustomLogos.SetField(fieldData)
          return;
        }
        ...
        if (fieldData.Entity === 'GetEPGFileNames') {
          getEPGFileNames.SetField(fieldData)
          return;
        }
        ...
        if (fieldData.Entity === 'GetLogContents') {
          getLogContents.SetField(fieldData)
          return;
        }
        if (fieldData.Entity === 'GetLogNames') {
          getLogNames.SetField(fieldData)
          return;
        }
        if (fieldData.Entity === 'GetLogo') {
          getLogo.SetField(fieldData)
          return;
        }
        if (fieldData.Entity === 'GetLogoForChannel') {
          getLogoForChannel.SetField(fieldData)
          return;
        }
        ...
        if (fieldData.Entity === 'GetSMChannelUniqueName') {
          getSMChannelUniqueName.SetField(fieldData)
          return;
        }
        ...
        if (fieldData.Entity === 'GetStreamConnectionMetricData') {
          getStreamConnectionMetricData.SetField(fieldData)
          return;
        }
        if (fieldData.Entity === 'GetStreamConnectionMetricDatas') {
          getStreamConnectionMetricDatas.SetField(fieldData)
          return;
        }
  ...
  const clearByTag = useCallback((data: ClearByTag): void => {
    ...
    if (Entity === 'GetEPGFileNames') {
      getEPGFileNames.ClearByTag(Tag)
      return;
    }
    if (Entity === 'GetEPGFilePreviewById') {
    ...
    if (Entity === 'GetLogContents') {
      getLogContents.ClearByTag(Tag)
      return;
    }
    if (Entity === 'GetLogNames') {
      getLogNames.ClearByTag(Tag)
      return;
    }
    if (Entity === 'GetLogo') {
      getLogo.ClearByTag(Tag)
      return;
    }
    if (Entity === 'GetLogoForChannel') {
      getLogoForChannel.ClearByTag(Tag)
      return;
    }
    if (Entity === 'GetLogos') {
    ...
    if (Entity === 'GetSMChannelUniqueName') {
      getSMChannelUniqueName.ClearByTag(Tag)
      return;
    }
    if (Entity === 'GetSMTasks') {
    ...
    if (Entity === 'GetStreamConnectionMetricData') {
      getStreamConnectionMetricData.ClearByTag(Tag)
      return;
    }
    if (Entity === 'GetStreamConnectionMetricDatas') {
      getStreamConnectionMetricDatas.ClearByTag(Tag)
      return;
    }
    if (Entity === 'GetStreamGroup') {
...
,
  ...
  const RemoveConnections = useCallback(() => {
    ...
    signalRService.removeListener('AuthLogOut', authLogOut);
  ...
  const CheckAndAddConnections = useCallback(() => {
    ...
    signalRService.addListener('AuthLogOut', authLogOut);
