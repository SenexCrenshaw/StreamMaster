...
import {FieldData, ChannelGroupDto,PagedResponse,QueryStringParameters } from '@lib/smAPI/smapiTypes';
...
const useGetPagedChannelGroups = (params?: QueryStringParameters | undefined | SkipToken): Result => {
