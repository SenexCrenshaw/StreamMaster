...
export const GetEpgColors = async (argument: iptv.EpgColorDto[]): Promise<iptv.EpgColorDto[] | null> =>
  invokeHubConnection<iptv.EpgColorDto[]>('GetEpgColors', argument);
export const GetEpgFile = async (argument: iptv.EpgFileDto): Promise<iptv.EpgFileDto | null> =>
  invokeHubConnection<iptv.EpgFileDto>('GetEpgFile', argument);
