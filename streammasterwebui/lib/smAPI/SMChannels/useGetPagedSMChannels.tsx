...
import {FieldData, SMChannelDto,PagedResponse,QueryStringParameters } from '@lib/smAPI/smapiTypes';
...
const useGetPagedSMChannels = (params?: QueryStringParameters | undefined): Result => {
