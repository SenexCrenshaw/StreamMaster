...
const useGetLineupPreviewChannel = (params?: GetLineupPreviewChannelRequest | undefined | SkipToken): Result => {
...
useEffect(() => {
  ...
  dispatch(fetchGetLineupPreviewChannel(params as GetLineupPreviewChannelRequest));
