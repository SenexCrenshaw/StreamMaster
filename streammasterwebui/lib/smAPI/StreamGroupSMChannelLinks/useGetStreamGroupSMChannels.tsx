...
const useGetStreamGroupSMChannels = (params?: GetStreamGroupSMChannelsRequest | undefined | SkipToken): Result => {
...
useEffect(() => {
  ...
  dispatch(fetchGetStreamGroupSMChannels(params as GetStreamGroupSMChannelsRequest));
