...
import {
  singletonVideoStreamLinksListener,
  singletonVideoStreamLinksRemoveListener,
} from '../signalr/singletonListeners'
    ...
    videoStreamLinksGetVideoStreamVideoStreamIds: {
      async onCacheEntryAdded(
        ...
        try {
          ...
          singletonVideoStreamLinksListener.addListener(
            updateCachedDataWithResults,
          )
          singletonVideoStreamLinksRemoveListener.addListener(
            removeCachedDataWithResults,
          )
          await cacheEntryRemoved
          singletonVideoStreamLinksListener.removeListener(
            updateCachedDataWithResults,
          )
          singletonVideoStreamLinksRemoveListener.removeListener(
            removeCachedDataWithResults,
          )
        } catch (error) {
