...
function bodyTemplate(data: object, fieldName: string, fieldType: ColumnFieldType, defaultIcon: string, camelize?: boolean) {
  switch (fieldType) {
    ...
    case 'm3ulink': return m3uLinkTemplate(data);
    case 'epglink': return epgLinkTemplate(data);
    case 'url': return urlTemplate(data);
    case 'epg': return epgSourceTemplate(getRecordString(data, 'user_Tvg_ID'));
    case 'image': return imageBodyTemplate(data, fieldName, defaultIcon);
    case 'streams':
