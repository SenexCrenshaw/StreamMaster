...
import { useEpgFilesRefreshEpgFileMutation, type EpgFileDto, type EpgFilesRefreshEpgFileApiArg } from "../../store/iptvApi";
...
const EPGFileRefreshDialog = ({ selectedFile }: EPGFileRefreshDialogProps) => {
  ...
  return (
    <FileRefreshDialog fileType="epg" inputInfoMessage={infoMessage} onRefreshFile={refreshFile} />
  );
}
