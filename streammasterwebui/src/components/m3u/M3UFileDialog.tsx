...
import FileDialog, { type FileDialogProps } from "../epg/FileDialog";
...
const M3UFileDialog: React.FC<Partial<FileDialogProps>> = () => {
  ...
  const createM3U = async (name: string, source: string) => {
  ...
  return (
    <FileDialog fileType="m3u" infoMessage={infoMessage} onCreateFromSource={createM3U} />
  )
}
