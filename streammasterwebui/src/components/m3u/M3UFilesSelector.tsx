import {
  ...
  type M3UFileDto,
  type M3UFilesGetPagedM3UFilesApiArg,
} from '@/lib/iptvApi'
...
const M3UFilesSelector = (props: M3UFilesSelectorProps) => {
  const [selectedM3UFile, setSelectedM3UFile] = useLocalStorage<M3UFileDto>(
    { id: 0, name: 'All' } as M3UFileDto,
    props.id + '-setSelectedM3UFile',
  )

  const m3uFilesQuery = useEpgFilesGetPagedEpgFilesQuery(
    {} as M3UFilesGetPagedM3UFilesApiArg,
  )
